    ...
    <div class="table-wrapper">
        ...
        <table class="table table-striped table-hover">
            ...
            <c:forEach var="contractDetail" items="${contractDetailList}">
                <tr>
                    <td><c:out value="${contractDetail.contractDetailId}"></c:out></td>
                    <td><c:out value="${contractDetail.quantity}"></c:out></td>
                    <td><c:out value="${contractDetail.contractId}"></c:out></td>
                    <td><c:out value="${contractDetail.attachServiceId}"></c:out></td>
                </tr>
            </c:forEach>
        </table>
    </div>
            ...
            <div class="modal-content">
                <form >
                    <div class="modal-header">
                        <h4 class="modal-title">Add Contract Detail</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="contractDetailId" class="form-control" required>
                        </div>
                        <div class="form-group">
