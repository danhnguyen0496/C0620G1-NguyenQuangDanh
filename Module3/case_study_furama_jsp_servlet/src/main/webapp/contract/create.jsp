    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="#addContractModal" class="btn btn-success" data-toggle="modal">
        ...
        <table id="tableStudent" class="table table-striped table-hover">
            ...
            <c:forEach var="contract" items="${contractList}">
                <tr>
                    ...
                    <td><c:out value="${contract.employeeId}"></c:out></td>
                    <td><c:out value="${contract.customerId}"></c:out></td>
                    <td><c:out value="${contract.serviceId}"></c:out></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
                ...
                <form>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Id</label>
                            <input type="text" name="contractId" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>StartDate</label>
                            <input type="text" name="contractStartDate" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>EndDate</label>
                            <input type="text" name="contractEndDate" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Deposit</label>
                            <input type="text" name="contractDeposit" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>TotalMoney</label>
                            <input type="text" name="contractTotalMoney" class="form-control" required>
                        </div>
