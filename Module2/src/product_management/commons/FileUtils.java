package product_management.commons;
...
public class FileUtils {
    private static ImportedProducts importedProducts;
    private static ExportProducts exportProducts;
    public static String COMMA = ",";
    public static String DOWN = "\n";
    public static final String path = "D:\\C0620G1-NguyenQuangDanh\\Module2\\src\\product_management\\data\\products.csv";
