...
public class ImportedProducts extends Product {
    ...
    public ImportedProducts(int id, String codeProduct, String nameProduct, double priceProduct, int quantityProduct, String manufacturer, double priceImportedProduct, String provinceImportedProduct, double taxImportedProduct) {
